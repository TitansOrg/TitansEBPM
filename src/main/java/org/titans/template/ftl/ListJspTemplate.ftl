    ...
    <script>
        $(function () {
            ...
            var table = $("#dataTable").DataTable({
                ...
                ajax : {
                    ...
                    url : "<%=serverName%>/${function}/get${className}List.do",
                    dataSrc : ""
                },
                order : [[1, "asc"]],
        ...
        function addData() {
            ...
            var options = {
                ...
                title : "详细信息",
                url : "<%=serverName%>/${function}/${className?uncap_first}Detail.do",
                height : 500,
                width : 1000
            }
        ...
        function removeData() {
            ...
            if (ids.length > 0) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType:"json",
                    url: "<%=serverName%>/${function}/removeData.do",
                    data: {
